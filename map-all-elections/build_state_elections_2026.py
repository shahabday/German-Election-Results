...
map-all-elections/data/prepared/gemeinden.geojson used by everything else. So this script
...
Run from the repo root, after build_municipality_data.py:
    python map-all-elections/build_state_elections_2026.py
"""
import csv
import json
...
RAW_DIR = ROOT / "map-all-elections" / "data" / "special"
OUT_DIR = ROOT / "map-all-elections" / "data" / "prepared" / "landtag"
