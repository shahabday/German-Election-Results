...
Run from the repo root, after build_municipality_data.py:
    python map-municipality/build_rlp_2026.py
"""
import json
import re
...
XLSX_PATH = ROOT / "map-municipality" / "data" / "special" / "rlp_2026" / "stimmbezirke.xlsx"
BOUNDARY_PATH = ROOT / "map-municipality" / "data" / "prepared" / "gemeinden.geojson"
OUT_PATH = ROOT / "map-municipality" / "data" / "prepared" / "landtag" / "rhineland_palatinate" / "2026.json"
